...
INPUT_CSV = BASE_DIR / "data" / "sexism.csv"
OUTPUT_JSONL = BASE_DIR / "results" / "sexism_eval_results.jsonl"
SUMMARY_JSON = BASE_DIR / "results" / "sexism_eval_summary.json"
...
def main():
    ...
    precision, recall, f1, _ = precision_recall_fscore_support(
        y_true, y_pred, average="binary", pos_label="sexist", zero_division=0
    )
